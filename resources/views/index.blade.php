      ...
      <div class="container my-5">
        <div class="row">
          ...
          <div class="col-md-5" id="nd1">
            ...
            <h3><b>KHOA HỌC – AN TOÀN – HIỆU QUẢ</b></h3>
            ...
            <p>Tính hiệu quả của một sản phẩm đến từ thành phần chất lượng, hoạt tính phù hợp với từng vấn đề về da.
              <br>Sản phẩm của DrCeutics còn đặc biệt quan tâm đển dạng bào chế với pH phù hợp để sản phẩm vừa hiệu quả vừa an toàn.
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item {{ $i == 0 ? 'active' : '' }}">
              <div class="row justify-content-center">
                ...
                <div class="col-md-4">
                  <a href="{{ route('sanpham.show', $product->id) }}" style="text-decoration: none; font-weight: bold; color:black; font-size: 20px"> @if ($product->image)
